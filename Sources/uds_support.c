...
/*******************************************************************************
    Global Varaibles
*******************************************************************************/
uint8 ASC_boot_ver[10]=
{'v', 'e', 'r', '-', '0', '.', '0', '1', 0, 0};
extern uint8 uds_session;
uint8 ASC_sys_supplier_id[5]=
{'1', '2', '3', '4', '5'};
uint8 ASC_soft_ver[10]=
{'v', 'e', 'r', '-', '0', '.', '0', '1', 0, 0};
uint8 ASC_sys_name[10]=
{'I', 'C', 'U', '-', 'm', '1', '2', 'e', 0, 0};


//uint8 ASC_ecu_part_num[15]  __at(0x20000400);
//uint8 BCD_manufacture_date[3] __at(0x2000040F);
//uint8 HEX_ecu_sn[10] __at(0x20000412);
//uint8 ASC_VIN[17] __at(0x2000041C);
//uint8 HEX_tester_sn[10] __at(0x2000042D);
//uint8 BCD_program_date[3] __at(0x20000437);
...
uint8 backlight_level[2];
uint8 buzzer[2];
uint8 gages[2];
uint8 segment_disp[2];
uint8 indicator[6];
